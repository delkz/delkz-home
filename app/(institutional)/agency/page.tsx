...
export default function agencyPage() {
    return (
        <div id="agency-page" className="text-center text-white">
            ...
            <section id="hero" className="min-h-[65dvh] flex items-center justify-center relative">
                ...
                <video
                    className="max-w-full absolute top-0 left-0 w-full h-full object-cover z-[-1] opacity-10"
                    src="agency/852421-hd_1920_1080_30fps.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
            ...
            <section id='portfolio' className='bg-[#050009]'>
                <div className="container mx-auto px-5 py-5">
                    <Portfolio showTitle={false} />
                </div>
            </section>
            <div className="container mx-auto px-5 py-20">


                <section id="cta" className='grid grid-cols-1 md:grid-cols-2 gap-5 mt-10'>
                    ...
                    <div className='text-left' id="contact-form">
                        {process.env.RECAPTCHA_SITE && <ContactForm useTitle={false} sitekey={process.env.RECAPTCHA_SITE} />}
                    </div>
                </section>
            </div>
